...
async function updateWindowTitle() {
  ...
  if (rootName && rootDirPath) title = `${currentFile ? pathBasename(currentFile) + ' - ' : ''}${rootName} - Axiom Editor`;
  else if (currentFile) title = `${pathBasename(currentFile)} - Axiom Editor`;
...
async function renderWelcomeScreen() {
  ...
  welcome.innerHTML = `
    <div class="welcome-hero">
      <img src="/logo.png" class="welcome-logo" alt="Logo" style="width: 80px; height: 80px; margin-bottom: 20px; object-fit: contain; pointer-events: none;" />
